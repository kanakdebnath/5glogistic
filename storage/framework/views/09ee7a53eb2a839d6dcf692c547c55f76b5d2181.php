    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <?php if(adminAccessRoute(config('role.manage_category.access.view'))): ?>
                    
                    <li class="list-divider"></li>
                    <li class="nav-small-cap"><span class="hide-menu"><?php echo app('translator')->get('Manage Category'); ?></span></li>
                    <li class="sidebar-item <?php echo e(menuActive(['admin.categoryList','admin.categoryCreate','admin.categoryEdit*'],3)); ?>">
                        <a class="sidebar-link" href="<?php echo e(route('admin.categoryList')); ?>" aria-expanded="false">
                            <i class="fas fa-cubes"></i>
...
<?php /**PATH /home/perhiasanintan/public_html/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>