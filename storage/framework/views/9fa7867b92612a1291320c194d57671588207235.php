            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <th scope="col"><?php echo app('translator')->get('Bank Name'); ?></th>
                        <th scope="col"><?php echo app('translator')->get('Account Holder'); ?></th>
                        <th scope="col"><?php echo app('translator')->get('Bank Account'); ?></th>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td data-label="<?php echo app('translator')->get('Bank Name'); ?>"><?php echo e(optional($item->account)->bank->name); ?></td>
                            <td data-label="<?php echo app('translator')->get('Account Holder'); ?>"><?php echo e(optional($item->account)->account_holder); ?></td>
                            <td data-label="<?php echo app('translator')->get('Bank Account'); ?>"><?php echo e(optional($item->account)->bank_account); ?></td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/perhiasanintan/public_html/resources/views/admin/payout/logs.blade.php ENDPATH**/ ?>