                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $managePlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td data-label="<?php echo app('translator')->get('Image'); ?>">
                                <img class="img img-fluid" style="width: 100px;" src="<?php echo e(asset(config('location.plan.path').$item->image)); ?>">
                            </td>
                            <td data-label="<?php echo app('translator')->get('Name'); ?>">
                                <?php echo app('translator')->get($item->name); ?>
                            </td>
                            <td data-label="<?php echo app('translator')->get('Name'); ?>">
                                <?php echo app('translator')->get($item->category->name); ?>
                            </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\intan\resources\views/admin/plan/list.blade.php ENDPATH**/ ?>