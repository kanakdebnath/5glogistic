<?php $__env->startSection('title',trans('Transaction').': '.$user->username ); ?>
                    ...
                    <tr>
                        ...
                        <td data-label="<?php echo app('translator')->get('User Name'); ?>">
                            <a href="<?php echo e(route('admin.user-edit',$row->user_id)); ?>" target="_blank">
                                <?php echo app('translator')->get(optional($row->user)->username); ?>
                            </a>
                        </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/perhiasanintan/public_html/resources/views/admin/users/transactions.blade.php ENDPATH**/ ?>