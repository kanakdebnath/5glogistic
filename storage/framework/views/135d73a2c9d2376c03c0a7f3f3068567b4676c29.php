...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            ...
            <form method="post" action="<?php echo e(route('admin.planUpdate',[$data->id])); ?>" enctype="multipart/form-data" class="form-row justify-content-center">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="category_id" id="category_id" class="form-control">
                                <option value="" disabled><?php echo app('translator')->get('Select a Category'); ?></option>
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>" <?php if(old('category_id', $data->category_id) == $item->id): ?> selected="selected" <?php endif; ?>><?php echo e($item->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><?php echo app('translator')->get('Maximum Users'); ?></label>
                                <input type="number" name="max_users" value="<?php echo e(old('max_users', $data->max_users)); ?>" placeholder="<?php echo app('translator')->get('Maximum Users'); ?>" class="form-control" >
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><?php echo app('translator')->get('Maximum Single User'); ?></label>
                                <input type="number" name="max_per_user" value="<?php echo e(old('max_per_user', $data->max_per_user)); ?>" placeholder="<?php echo app('translator')->get('Maximum Single User'); ?>" class="form-control" >
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="description" id="description" class="form-control"><?php echo e(old('description', $data->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><?php echo app('translator')->get('Plan Thumbnail'); ?></label>
                                <div class="image-input">
                                    <label for="image-upload" id="image-label"><i class="fas fa-upload"></i></label>
                                    <input type="file" name="image" placeholder="<?php echo app('translator')->get('Choose image'); ?>" id="image">
                                    <img id="image_preview_container" class="preview-image" src="<?php echo e(getFile(config('location.plan.path').$data->image) ? : 0); ?>"alt="preview image">
                                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\intan\resources\views/admin/plan/edit.blade.php ENDPATH**/ ?>