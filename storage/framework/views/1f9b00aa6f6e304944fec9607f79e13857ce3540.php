...
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/Lay/css/layui.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/css/main.css?v2.7')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/layer_mobile/need/layer.css')); ?>?v1.6" />
<script src="<?php echo e(asset('assets/frontend/Lay/layui.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/js/comm.js')); ?>"></script>
...
<script type="text/javascript">
    layui.use(['form', 'layedit', 'laydate', 'layer', 'carousel', 'flow', 'element', 'cookie', 'mobile'], function () {
        ...
        $().ready(function () {
            ...
            $("#copy").attr("data-clipboard-text", "<?php echo e(Auth::user()->referral_link); ?>");
            var clipboard = new ClipboardJS('#copy');
            clipboard.on('success', function (e) {
                error("Copy successfully");
            });

            $("#copy1").attr("data-clipboard-text", "<?php echo e(Auth::user()->referral_code); ?>");
            ...
            $(document).on("click", '#task', function () {
                url = "<?php echo e(route('user.team-info')); ?>";
                layer.open({
                    type: 2,
                    title: false,
                    area: ['100%', '100%'],
...
<body style="background-size: 100% auto; background: linear-gradient(to top, #071730, #071730); ">
    ...
    <div style=" max-width:450px; margin:0 auto;">
            ...
            <div style="margin-top:25px;color: #FFFFFF; text-align:center; height:25px; line-height:25px;position:relative;">
                ...
                <div style="position: absolute; top: -5px; text-align: right;  right:12px; ">
                    <div class="layui-btn layui-btn-sm" style="background-image: linear-gradient(to right,#0f2756,#0f2756); border: 0px; border-radius: 3px; color: #fff; " id="task">
                        Tim saya&nbsp;
                        <img src="<?php echo e(asset('assets/frontend/ui/team.png')); ?>" style="height:15px;" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="  margin-bottom: 100px;">
            ...
            <div style=" background: url(<?php echo e(asset('assets/frontend/ui/teambg.png')); ?>) no-repeat; background-size: 100% auto; height: auto; overflow: hidden; border-radius: 5px; color: #fff; width: 98%; height: auto; margin: 0 auto; margin-top: 12px; position: relative; ">
                <div style="padding: 10px;font-size: 16px; margin-top: 10px; height: auto; overflow: hidden;">
                    <div style="float: left; width: 70%; height: 30px; line-height: 30px;">
                        <img src="<?php echo e(asset('assets/frontend/ui/t1.png')); ?>" style="height:20px; margin-left:20px; " /><span style="margin-left:10px;" id="inv"><?php echo e(Auth::user()->referral_code); ?></span>
                    </div>
                ...
                <div style="padding: 10px; font-size: 12px; height: auto; overflow: hidden; padding-bottom:35px;">
                    <div style="float: left; width: 70%; height: 30px; ">
                        <img src="<?php echo e(asset('assets/frontend/ui/t2.png')); ?>" style="height: 20px; margin-left: 20px; " /><span style="margin-left: 10px; width: 170px; display: inline-block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; " id="link"><?php echo e(Auth::user()->referral_link); ?></span>
                    </div>
                    <div style="float:left;width:30%;">
            ...
            <div style="margin-top: 15px; color: #fff; height: auto; overflow: hidden;">
                <div style="float:left;width:50%; text-align:center;">
                    <div style="height: 60px; line-height: 20px; width: 90%; margin: 0 auto; background: linear-gradient(to right,#ddc088,#c0892f); border-radius: 5px;">
                        <div style=" width: 100%; padding-top: 10px; font-size: 16px;" id="number1"><?php echo e($levelOneUsers + $levelTwoUsers + $levelThreeUsers); ?></div>
                        <div style=" width:100%;">Jumlah tim</div>
                    </div>
                </div>
                <div style="float: left; width: 50%; text-align: center;">
                    <div style="height: 60px; line-height: 20px; width: 90%; margin: 0 auto; background: linear-gradient(to right,#ddc088,#c0892f); border-radius: 5px; ">
                        <div style="width: 100%; padding-top: 10px; font-size:16px;" id="lvincome">Rp <?php echo e(getAmount($levelOneIncome) + getAmount($levelTwoIncome) + getAmount($levelThreeIncome)); ?></div>
            ...
            <div style="margin-top: 20px; width: 100%;color: #FFFFFF; text-align: center; height: auto; overflow: hidden;">
                <table style="width: 98%; background: #091427; color: #394969; font-size: 12px; border: 1px solid #222; margin-top: 0px; padding-top: 0px; margin: 0 auto;">
                    ...
                    <tr style="background: #091427; border: 1px solid #222; height: 35px; line-height: 35px; ">
                        <td style="font-size:12px;">Level 1 team <?php echo e($referrals->where('level', 1)->first()->percent); ?>%</td>
                        <td style="font-size:12px;color:#FFE393;" id="task_count1"><?php echo e($levelOneUsers); ?></td>
                        <td style="font-size:12px;color:#FFE393;" id="task_income1">Rp <?php echo e(getAmount($levelOneIncome)); ?></td>
                    </tr>
                    <tr style="background: #091427; border: 1px solid #222; height: 35px; line-height: 35px; ">
                        <td style="font-size:12px;">Level 2 team <?php echo e($referrals->where('level', 2)->first()->percent); ?>%</td>
                        <td style="font-size:12px;color:#FFE393;" id="task_count3"><?php echo e($levelTwoUsers); ?></td>
                        <td style="font-size:12px;color:#FFE393;" id="task_income3">Rp <?php echo e(getAmount($levelTwoIncome)); ?></td>
                    </tr>
                    <tr style="background: #091427; border: 1px solid #222; height: 35px; line-height: 35px; ">
                        <td style="font-size:12px;">Level 3 team <?php echo e($referrals->where('level', 3)->first()->percent); ?>%</td>
                        <td style="font-size:12px;color:#FFE393;" id="task_count4"><?php echo e($levelThreeUsers); ?></td>
                        <td style="font-size:12px;color:#FFE393;" id="task_income4">Rp <?php echo e(getAmount($levelThreeIncome)); ?></td>
                    </tr>
                </table>
            </div>
            ...
            <div style="width: 100%; height: auto; overflow: hidden;">
                <div style="color: <?php if(Auth::user()->active_invites >= 5): ?> #c0892f <?php else: ?> #aaa <?php endif; ?>; background: linear-gradient(to left,#0f2756,#061324); font-size: 14px; width: 92%; margin: 0 auto; padding: 8px; margin-top: 10px; border-radius: 3px; ">
                ...
                <div style="width: 100%; height: auto; overflow: hidden; border-bottom: 1px solid #c0892f; padding-bottom:35px;">
                    <div style="width:50%; float:left;text-align:center;">
                        <div style="font-weight: bold; font-size: 20px; padding-top: 15px; color: #c0892f;" >
                            <font id="task_count_1"><?php if(Auth::user()->active_invites > 5): ?> 5 <?php else: ?> <?php echo e(Auth::user()->active_invites); ?> <?php endif; ?></font> / 5
                        </div>
                        <div style="color: #fff; padding-top: 8px;">Proses</div>
                    </div>
                    <div style="width:50%; float:left;text-align:center;">
                        <div style="font-weight: bold; font-size: 20px; padding-top: 15px; color: #c0892f; " id="task_income_1">Rp <?php if(Auth::user()->active_invites > 4): ?> 20,000 <?php else: ?> 0 <?php endif; ?></div>
                        <div style="color: #fff; padding-top: 8px;">Bonus</div>
                    </div>
                </div>

                <div style="color: <?php if(Auth::user()->active_invites >= 30): ?> #c0892f <?php else: ?> #aaa <?php endif; ?>; background: linear-gradient(to left,#0f2756,#061324); font-size: 14px; width: 92%; margin: 0 auto; padding: 8px; margin-top: 10px; border-radius: 3px; ">
                    Undang 30 teman untuk membeli produk, dan dapatkan bonus Rp 100,000
                </div>
                <div style="width: 100%; height: auto; overflow: hidden; border-bottom: 1px solid #c0892f; padding-bottom:35px;">
                    <div style="width:50%; float:left;text-align:center;">
                        <div style="font-weight: bold; font-size: 20px; padding-top: 15px; color: #c0892f;" >
                            <font id="task_count_2"><?php if(Auth::user()->active_invites > 30): ?> 30 <?php else: ?> <?php echo e(Auth::user()->active_invites); ?> <?php endif; ?></font> / 30
                        </div>
                        <div style="color: #fff; padding-top: 8px;">Proses</div>
                    </div>
                    <div style="width:50%; float:left;text-align:center;">
                        <div style="font-weight: bold; font-size: 20px; padding-top: 15px; color: #c0892f; " id="task_income_2">Rp <?php if(Auth::user()->active_invites > 29): ?> 1,00,000 <?php else: ?> 0 <?php endif; ?></div>
                        <div style="color: #fff; padding-top: 8px;">Bonus</div>
                    </div>
                </div>

                <div style="color: <?php if(Auth::user()->active_invites >= 65): ?> #c0892f <?php else: ?> #aaa <?php endif; ?>; background: linear-gradient(to left,#0f2756,#061324); font-size: 14px; width: 92%; margin: 0 auto; padding: 8px; margin-top: 10px; border-radius: 3px; ">
                    Undang 65 teman untuk membeli produk, dan dapatkan bonus Rp 250,000
                </div>
                <div style="width: 100%; height: auto; overflow: hidden; border-bottom: 1px solid #c0892f; padding-bottom:35px;">
                    <div style="width:50%; float:left;text-align:center;">
                        <div style="font-weight: bold; font-size: 20px; padding-top: 15px; color: #c0892f;" >
                            <font id="task_count_3"><?php if(Auth::user()->active_invites > 65): ?> 65 <?php else: ?> <?php echo e(Auth::user()->active_invites); ?> <?php endif; ?></font> / 65
                        </div>
                        <div style="color: #fff; padding-top: 8px;">Proses</div>
                    </div>
                    <div style="width:50%; float:left;text-align:center;">
                        <div style="font-weight: bold; font-size: 20px; padding-top: 15px; color: #c0892f; " id="task_income_3">Rp <?php if(Auth::user()->active_invites > 64): ?> 2,50,000 <?php else: ?> 0 <?php endif; ?></div>
                        <div style="color: #fff; padding-top: 8px;">Bonus</div>
                    </div>
                </div>

                <div style="color: <?php if(Auth::user()->active_invites >= 180): ?> #c0892f <?php else: ?> #aaa <?php endif; ?>; background: linear-gradient(to left,#0f2756,#061324); font-size: 14px; width: 92%; margin: 0 auto; padding: 8px; margin-top: 10px; border-radius: 3px; ">
                    Undang 180 teman untuk membeli produk, dan dapatkan bonus Rp 1,000,000
                </div>
                <div style="width: 100%; height: auto; overflow: hidden; border-bottom: 1px solid #c0892f; padding-bottom:35px;">
                    <div style="width:50%; float:left;text-align:center;">
                        <div style="font-weight: bold; font-size: 20px; padding-top: 15px; color: #c0892f;" >
                            <font id="task_count_3"><?php if(Auth::user()->active_invites > 180): ?> 180 <?php else: ?> <?php echo e(Auth::user()->active_invites); ?> <?php endif; ?></font> / 180
                        </div>
                        <div style="color: #fff; padding-top: 8px;">Proses</div>
                    </div>
                    <div style="width:50%; float:left;text-align:center;">
                        <div style="font-weight: bold; font-size: 20px; padding-top: 15px; color: #c0892f; " id="task_income_3">Rp <?php if(Auth::user()->active_invites > 179): ?> 10,00,000 <?php else: ?> 0 <?php endif; ?></div>
                        <div style="color: #fff; padding-top: 8px;">Bonus</div>
                    </div>
                </div>

                <div style="color: <?php if(Auth::user()->active_invites >= 500): ?> #c0892f <?php else: ?> #aaa <?php endif; ?>; background: linear-gradient(to left,#0f2756,#061324); font-size: 14px; width: 92%; margin: 0 auto; padding: 8px; margin-top: 10px; border-radius: 3px; ">
                    Undang 500 teman untuk membeli produk, dan dapatkan bonus Rp 4,000,000
                </div>
                <div style="width: 100%; height: auto; overflow: hidden; border-bottom: 1px solid #c0892f; padding-bottom:35px;">
                    <div style="width:50%; float:left;text-align:center;">
                        <div style="font-weight: bold; font-size: 20px; padding-top: 15px; color: #c0892f;" >
                            <font id="task_count_3"><?php if(Auth::user()->active_invites > 499): ?> 500 <?php else: ?> <?php echo e(Auth::user()->active_invites); ?> <?php endif; ?></font> / 500
                        </div>
                        <div style="color: #fff; padding-top: 8px;">Proses</div>
                    </div>
                    <div style="width:50%; float:left;text-align:center;">
                        <div style="font-weight: bold; font-size: 20px; padding-top: 15px; color: #c0892f; " id="task_income_3">Rp <?php if(Auth::user()->active_invites > 499): ?> 40,00,000 <?php else: ?> 0 <?php endif; ?></div>
                        <div style="color: #fff; padding-top: 8px;">Bonus</div>
                    </div>
                </div>
        ...
        <nav class="nav" style="background-size:100% 100%; height:60px; ">
            <div url="<?php echo e(route('home')); ?>" class="navtab">
                <img src="<?php echo e(asset('assets/frontend/ui/nav/1.png')); ?>" class="gray" style="height: 25px;" /> <br />
                <span id="nav_btn1">Utama</span>
            </div>
            <div url="<?php echo e(route('user.my-products')); ?>" class="navtab ">
                <img src="<?php echo e(asset('assets/frontend/ui/nav/2.png')); ?>" class="gray" style="height: 25px;" /> <br />
                <span id="nav_btn2">Portofolio</span>
            </div>
            <div url="#">
                <img src="<?php echo e(asset('assets/frontend/ui/nav/7.png')); ?>" class="logo" style="height: 55px; margin-top: -20px;" /> <br />
            </div>
            <div style="color: #AF873F !important; font-weight: bold; ">
                <img src="<?php echo e(asset('assets/frontend/ui/nav/4.png')); ?>" style="height: 25px; " /> <br />
                <span id="nav_btn3">Bonus Team</span>
            </div>
            <div url="<?php echo e(route('user.home')); ?>" class="navtab">
                <img src="<?php echo e(asset('assets/frontend/ui/nav/5.png')); ?>" class="gray" style="height: 25px;" /> <br />
...
<?php echo $__env->make($theme.'layouts.starline', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\intan\resources\views/themes/5glogistic/user/referral.blade.php ENDPATH**/ ?>