...
@section('content')
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            ...
            <form method="post" action="{{route('admin.planStore')}}" enctype="multipart/form-data" class="form-row justify-content-center">
                @csrf
                <div class="col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="max_users" value="{{old('max_users')}}" placeholder="@lang('Maximum Users')" class="form-control" >
                            @error('max_users')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="max_per_user" value="{{old('max_per_user')}}" placeholder="@lang('Maximum Single User')" class="form-control" >
                            @error('max_per_user')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="image-input">
                                ...
                                <img id="image_preview_container" class="preview-image" src="{{asset('assets/uploads/plan/default.jpg')}}"alt="preview image">
                            </div>
                            @error('image')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
