            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <th scope="col">@lang('Account Holder')</th>
                        <th scope="col">@lang('Bank Account')</th>
                    ...
                    @forelse($records as $key => $item)
                        <tr>
                            ...
                            <td data-label="@lang('Bank Name')">{{ optional($item->account)->bank->name }}</td>
                            <td data-label="@lang('Account Holder')">{{ optional($item->account)->account_holder }}</td>
                            <td data-label="@lang('Bank Account')">{{ optional($item->account)->bank_account }}</td>
