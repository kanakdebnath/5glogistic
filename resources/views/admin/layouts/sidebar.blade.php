    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                @if(adminAccessRoute(config('role.manage_category.access.view')))
                    {{--Manage Plan--}}
                    <li class="list-divider"></li>
                    <li class="nav-small-cap"><span class="hide-menu">@lang('Manage Category')</span></li>
                    <li class="sidebar-item {{menuActive(['admin.categoryList','admin.categoryCreate','admin.categoryEdit*'],3)}}">
                        <a class="sidebar-link" href="{{ route('admin.categoryList')}}" aria-expanded="false">
                            <i class="fas fa-cubes"></i>
