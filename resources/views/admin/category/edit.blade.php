...
@section('content')
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            ...
            <form method="post" action="{{route('admin.categoryUpdate',[$data->id])}}" enctype="multipart/form-data" class="form-row justify-content-center">
                @csrf
                @method('put')
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input data-toggle="toggle" id="capital_back" data-onstyle="success"
                                   ...
                                   type="checkbox" @if($data->capital_back) checked @endif name="capital_back">
                            @error('capital_back')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
