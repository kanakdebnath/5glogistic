...
@section('content')
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        ...
        <div class="card-body">
            ...
            <div class="media mb-4 justify-content-between">
                ...
                @if(adminAccessRoute(config('role.manage_category.access.add')))
                    <a href="{{route('admin.categoryCreate')}}" class="btn btn-sm  btn-primary mr-2">
                        <span><i class="fas fa-plus"></i> @lang('Add New')</span>
                    </a>
                @endif

                @if(adminAccessRoute(config('role.manage_category.access.edit')))
                    ...
                    @forelse($manageCategory as $item)
                        <tr>
                            ...
                            <td data-label="@lang('Capital Back')">
                                <?php echo $item->capitalBackMessage; ?>
                            </td>
                            ...
                            <td data-label="@lang('Action')">
                                <div class="dropdown show">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <a class="dropdown-item" href="{{ route('admin.categoryEdit',$item->id) }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-primary">
                    <h5 class="modal-title">@lang('Active Category Confirmation')</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">×</button>
                </div>
                <div class="modal-body">
                    <p>@lang("Are you really want to active the Category's")</p>
                </div>
    ...
    <div class="modal fade" id="all_inactive" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-primary">
                    <h5 class="modal-title">@lang('DeActive Category Confirmation')</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">×</button>
                </div>
                <div class="modal-body">
                    <p>@lang("Are you really want to Inactive the category's")</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-dismiss="modal"><span>@lang('No')</span></button>
                    <form action="" method="post">
