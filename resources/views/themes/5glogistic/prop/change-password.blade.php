...
<body style="background-size: 100% auto; background: url({{asset('assets/frontend/ui/bg4.png')}}) no-repeat; background-size: 100% auto;">
    <div style="width: 100%; margin: 0 auto; border-bottom: 0px solid #fff; background: none;" class="top">
        ...
        <font class="topname" style="color: #fff;" id="topname1">Ubah sandi utama</font>
    ...
    <div style=" max-width:450px; margin:0 auto;  ">
        <div class="layui-form layui-tab-content" style="padding:5px 10px; margin-top:50px;">
            <div class="layui-form layui-tab-content" style="padding: 10px 0;">
                <form class="layui-form" id="confirm-form">
                                    ...
                                    <div class="layui-form layui-form-pane">
                                        <div class="layui-form-item" style="height:48px;">
                                            <div class="inputdiv">
                                                ...
                                                <input type="password" id="oldpassword" maxlength="20" placeholder="Kata sandi sebelumnya" class="layui-input" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="layui-form-item" style="height:48px;">
                                            <div class="inputdiv">
                                                <i class="layui-icon layui-icon-password"></i>
                                                <input type="password" id="password1" maxlength="20" placeholder="Kata sandi baru" class="layui-input" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="layui-form-item" style="height:48px;">
                                            <div class="inputdiv">
                                                <i class="layui-icon layui-icon-password"></i>
                                                <input type="password" id="password2" maxlength="20" placeholder="Konfirmasi kata sandi" class="layui-input" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="layui-form-item" style="height:48px;">
