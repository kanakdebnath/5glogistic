        ...
        layui.config({
            ...
            $().ready(function () {
                ...
                $("#add-form").submit(function (e) {
                    ...
                    var bank_id = $("#bankcode").val();
                    var account_holder = $("#account_holder").val();
                    var bank_account = $("#bank_account").val();
                    // var IFSC = $("#IFSC").val();
                    var url = "{{route('user.store-account')}}";
                    var pm = {
                        _token: "{{csrf_token()}}",
                        bank_id: bank_id,
                    ...
                    <div class="layui-form layui-form-pane">
                        <form class="layui-form" id="add-form">
                            <div class="layui-form-item" style="height:45px;">
                                <div >
                                    <select id="bankcode" class="layui-input"  style="color: #fff; display: none; width:100%; border: 0px; background: none;" placeholder=""  lay-verify="required" lay-search="">
                            ...
                            <div class="layui-form-item" style="height:45px;">
                                <div class="inputdiv">
                                    ...
                                    <input type="text" id="account_holder" maxlength="49" autocomplete="new-password" style="color: #fff; border: 0px; background: none;" placeholder="Masukkan nama pemilik" class="layui-input" />
                                </div>
                            </div>
                            <div class="layui-form-item" style="height:45px;">
                                <div class="inputdiv">
                                    <img src="{{asset('assets/frontend/ui/icon-bank.png')}}" style="height: 18px; margin-right: 5px; margin-top: 8px;" />
                                    <input type="number" id="bank_account" autocomplete="new-password" style="color: #fff; border: 0px; background: none;" maxlength="49" placeholder="Masukkan nomor akun bank" class="layui-input" />
                                </div>
                            </div>
                            {{-- <div class="layui-form-item" style="height:45px;display:none;">
                                <div class="inputdiv">
                                    IFSC
                                    <input type="text" id="IFSC" autocomplete="new-password" style="color: #fff; border: 0px; background: none;" maxlength="11" placeholder="Please enter your IFSC" class="layui-input" />
                                </div>
                            </div> --}}
                            <div class="layui-form-item" style="margin-top:25px;">
                                <input class="layui-btn" id="add" value="Add" style="width: 100%; border-radius: 25px; color: #fff; font-weight: bold; background-image: linear-gradient(to right,#ddc088,#c0892f); font-size: 16px; border: 0px; border-radius: 10px; " type="submit" />
                            </div>
                        </form>
                    </div>
                </div>
