                    ...
                    <div class="flex bg-gray-800 rounded-lg">
                        <div class="flex-1">
                            <div class="col-lg-12 my-5 py-5 text-center">
                                <span class="title display-1 d-block text-white text-2xl mb-8">{{trans('405')}}</span>
                                <div class="sub_title lead mt-4 mb-4 text-white text-xl">{{trans("Method Not Allowed")}}</div>
