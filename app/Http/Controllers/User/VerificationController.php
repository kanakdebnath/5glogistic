...
class VerificationController extends Controller
{
        ...
        elseif (!$user->sms_verification) {
            if (!$this->checkValidCode($user, $user->verify_code)) {
                ...
                $this->sms($user, 'VERIFICATION_CODE', [
                 ...
                 session()->flash('success', 'OTP SMS telah dikirimkan.');
            }
    ...
    public function resendCode()
    {
        ...
        if ($type === 'email') {
            ...
            return back()->with('success', 'OTP SMS telah dikirimkan.');
        } else {
    ...
    public function mailVerify(Request $request)
    {
        ...
        $msg = [
            'code.required' => 'Masukkan kode verifikasi email.',
        ];
        ...
        throw ValidationException::withMessages(['error' => 'Kode Verifikasi tidak valid.']);
    }
    ...
    public function twoFAverify(Request $request)
    {
        ...
        throw ValidationException::withMessages(['error' => 'Kode Verifikasi salah.']);
