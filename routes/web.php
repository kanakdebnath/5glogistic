...
Route::group(['middleware' => ['auth'], 'prefix' => 'user', 'as' => 'user.'], function () {
    ...
    Route::middleware('userCheck')->group(function () {
        Route::middleware('kyc')->group(function () {
            ...
            // Plan
            Route::get('/plan', 'User\HomeController@planList')->name('plan');
            ...
            Route::get('/investments', 'User\HomeController@investments')->name('investments');
            ...
            Route::get('/payment-methods/list', 'User\HomeController@listPaymentMethods')->name('paymentmethods.list');
            Route::get('/payment-methods/create', 'User\HomeController@createPaymentMethods')->name('paymentmethods.create');
            Route::post('/payment-methods/store', 'User\HomeController@storePaymentMethods')->name('paymentmethods.store');
            Route::get('/payment-methods/edit/{id}', 'User\HomeController@editPaymentMethods')->name('paymentmethods.edit');
            Route::post('/payment-methods/update/{id}', 'User\HomeController@updatePaymentMethods')->name('paymentmethods.update');

             // capital back

            Route::post('/capital-back', 'User\HomeController@CapitalBack')->name('capitalback');
            Route::post('/upgrate-plan', 'User\HomeController@upgradePlan')->name('upgrade-plan');
            Route::post('/upgrate-plan-store', 'TopPayController@toppay_plan_upgrade')->name('upgrade-plan-store');
            ...
            Route::get('/bonus-history', 'User\HomeController@bonus_history')->name('bonus_history');
            ...
            Route::get('referral-level/{level}','User\HomeController@level')->name('referral.member');
            ...
            Route::post('/payment/checkout', 'User\HomeController@checkout')->name('payment.checkout');
            Route::get('/callback', 'User\HomeController@callback')->name('payment.callback');
            Route::get('/callback-new', 'User\HomeController@callback_new')->name('payment.callback_new');
            
            Route::post('/toppay/checkout', 'TopPayController@checkout')->name('toppay.checkout');
            Route::get('/toppay/callback', 'TopPayController@callback')->name('toppay.callback');
            Route::post('/toppay/payout', 'TopPayController@payoutMoneyRequest')->name('toppay.moneyRequest');
...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['auth:admin','permission']], function () {
        ...
        Route::get('/category-list', 'Admin\ManageCategoryController@categoryList')->name('categoryList');
        Route::get('/category-create', 'Admin\ManageCategoryController@categoryCreate')->name('categoryCreate');
        Route::post('/category-create', 'Admin\ManageCategoryController@categoryStore')->name('categoryStore');
        Route::get('/category-edit/{id}', 'Admin\ManageCategoryController@categoryEdit')->name('categoryEdit');
        Route::put('/category-edit/{id}', 'Admin\ManageCategoryController@categoryUpdate')->name('categoryUpdate');
        Route::post('/category-active', 'Admin\ManageCategoryController@activeMultiple')->name('category-active');
        Route::post('/category-inactive', 'Admin\ManageCategoryController@inActiveMultiple')->name('category-inactive');
...
Route::get('verification-code', 'FrontendController@verificationCode')->name('verificationCode');
...
Route::get('/plan/details/{id}', 'FrontendController@planDetails')->name('plan.details');
